      ...
      <LuxCard style={styles.accountCard}>
        <View style={styles.accountRow}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            <TouchableOpacity style={styles.editBtn} onPress={() => router.push("/account/edit")} activeOpacity={0.75}>
        ...
        <View style={styles.usageMeter}>
          <View style={styles.usageRow}>
            ...
            <Text style={styles.usageCount}>{vehicles.length} / {FREE_TIER_LIMIT}</Text>
          </View>
