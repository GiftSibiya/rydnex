                ...
                <Text style={styles.statNum}>
                  {vRules.filter((r) => {
                    ...
                    const maxPct = Math.max(
                      r.intervalKm > 0 ? kmSince / r.intervalKm : 0,
                      r.intervalDays > 0 ? daysSince / r.intervalDays : 0
                    );
          ...
          {usePreset ? (
              ...
              {PRESET_PARTS.map((p) => (
                ...
                >
                  ...
                  <Text style={styles.presetMeta}>
                    {(p.intervalKm / 1000).toFixed(0)}k km · {Math.round(p.intervalDays / 30)}mo
                  </Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            <View style={styles.formGrid}>
              <LuxInput
                ...
                value={form.partName}
                onChangeText={(t) => setForm((f) => ({ ...f, partName: t }))}
              ...
              <LuxInput
                ...
                onChangeText={(t) => setForm((f) => ({ ...f, intervalKm: t }))}
              ...
              <LuxInput
                ...
                onChangeText={(t) => setForm((f) => ({ ...f, intervalDays: t }))}
                keyboardType="numeric"
